...
#include "HTTPSRedirectESP8266Module.h"
#include "DebugMacros.h"

HTTPSRedirectESP8266Module::HTTPSRedirectESP8266Module(void) : _httpsPort(443){
  Init();
}

HTTPSRedirectESP8266Module::HTTPSRedirectESP8266Module(const int p) : _httpsPort(p){
  Init();
}

HTTPSRedirectESP8266Module::~HTTPSRedirectESP8266Module(){ 
}

void HTTPSRedirectESP8266Module::Init(void){
  _keepAlive = true;
...
bool HTTPSRedirectESP8266Module::printRedir(void){
...
void HTTPSRedirectESP8266Module::createGetRequest(const String& url, const char* host){
...
void HTTPSRedirectESP8266Module::createPostRequest(const String& url, const char* host, const String& payload){
...
bool HTTPSRedirectESP8266Module::getLocationURL(void){
...
void HTTPSRedirectESP8266Module::fetchHeader(void){
  String line = "";
  int pos = -1;
  int pos2 = -1;
  int pos3 = -1;
...
void HTTPSRedirectESP8266Module::fetchBodyUnChunked(unsigned len){
  String line;
  DPRINTLN("Body:");
...
// http://fssnip.net/2t
void HTTPSRedirectESP8266Module::fetchBodyChunked(void){
  String line;
  int chunkSize;
...
unsigned int HTTPSRedirectESP8266Module::getResponseStatus(void){
...
bool HTTPSRedirectESP8266Module::GET(const String& url, const char* host){
  return GET(url, host, _printResponseBody);
}

bool HTTPSRedirectESP8266Module::GET(const String& url, const char* host, const bool& disp){
  bool retval;
  bool oldval;
...
bool HTTPSRedirectESP8266Module::POST(const String& url, const char* host, const String& payload){
  return POST(url, host, payload, _printResponseBody);
}

bool HTTPSRedirectESP8266Module::POST(const String& url, const char* host, const String& payload, const bool& disp){
  bool retval;
  bool oldval;
...
void HTTPSRedirectESP8266Module::InitResponse(void){
  // Init response data
  _myResponse.body = "";
...
int HTTPSRedirectESP8266Module::getStatusCode(void){
  return _myResponse.statusCode;
}

String HTTPSRedirectESP8266Module::getReasonPhrase(void){
  return _myResponse.reasonPhrase;
}

String HTTPSRedirectESP8266Module::getResponseBody(void){
  return _myResponse.body;
}

void HTTPSRedirectESP8266Module::setPrintResponseBody(bool disp){
  _printResponseBody = disp;
}

void HTTPSRedirectESP8266Module::setMaxRedirects(const unsigned int n){
  _maxRedirects = n;  // to-do: use this in code above
}

void HTTPSRedirectESP8266Module::setContentTypeHeader(const char *type){
  _contentTypeHeader = type;
}

#ifdef OPTIMIZE_SPEED
bool HTTPSRedirectESP8266Module::reConnectFinalEndpoint(void){
...
#ifdef EXTRA_FNS
void HTTPSRedirectESP8266Module::fetchBodyRaw(void){
  String line;
...
void HTTPSRedirectESP8266Module::printHeaderFields(void){
