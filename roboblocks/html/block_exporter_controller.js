...
BlockExporterController.prototype.export = function() {
  ...
  var definitionFormat = 'JavaScript';
  var filename = document.getElementById('filename').value;
  var language = 'Arduino';
  
  var blockDefs = this.tools.getBlockDefinitions(blockXmlMap,definitionFormat);
  var genStubs = this.tools.getGeneratorCode(blockXmlMap,language);
  var html = this.tools.getGeneratorHTML(blockXmlMap);
  //console.log(html);
  var all_code = blockDefs.concat('\n\n',genStubs);
  FactoryUtils.createAndDownloadFile(all_code, filename, 'Facilino Block');
};
