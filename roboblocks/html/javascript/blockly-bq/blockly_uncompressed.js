...
Blockly.Workspace.prototype.renameVariable = function(a, b) {
    var c, d = this.variableIndexOf(a),
        e = this.variableIndexOf(b); - 1 != e && this.variableList[e] != b && (c = this.variableList[e]);
...
Blockly.Trashcan.prototype.createDom = function() {
    ...
    }, this.svgGroup_).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", "./media/sprites.png");//this.workspace_.options.pathToMedia + Blockly.SPRITE.url);
    b = Blockly.utils.createSvgElement("clipPath", {
    ...
    this.svgLid_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", "./media/sprites.png"); //this.workspace_.options.pathToMedia + Blockly.SPRITE.url);
...
Blockly.WorkspaceSvg.prototype.paste = function(a) {
    if (this.rendered && !(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
        ...
        try {
            ...
            var c = parseInt(a.getAttribute("x"), 10),
...
Blockly.Block.prototype.interpolate_ = function(a, b, c) {
    ...
    a.length && ("string" == typeof a[a.length -
        1] || goog.string.startsWith(a[a.length - 1].type, "field_")) && (g = {
        type: "input_dummy"
...
Blockly.BlockSvg.prototype.onMouseDown_ = function(a) {
    if (!this.workspace.options.readOnly)
        if (this.isInFlyout) "touchstart" == a.type && Blockly.utils.isRightButton(a) && (Blockly.Flyout.blockRightClick_(a, this), a.stopPropagation(), a.preventDefault());
        else {
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation();
        ...
        if (Blockly.dragMode_ == Blockly.DRAG_STICKY && goog.math.Coordinate.distance(b, c) * this.workspace.scale > Blockly.DRAG_RADIUS) {
            ...
            if (a.altKey || a.ctrlKey || a.metaKey) e = !e;
            this.unplug(e);
...
Blockly.BlockSvg.prototype.updateCursor_ = function(a, b) {
    var c = this.workspace.isDeleteArea(a),
        d = Blockly.selected && b && c != Blockly.DELETE_AREA_TOOLBOX;
...
Blockly.Variables.flyoutCategory = function(a) {
    ...
    c.push(d);
    if (0 < b.length)
        for (Blockly.Blocks.variables_set && (a = Blockly.Blocks.math_change ? 8 : 24, d = '<xml><block type="variables_set" gap="' + a +
    ...
    return function(c) {
        if (!Blockly.utils.isRightButton(c) && !a.disabled) {
            ...
            if (goog.userAgent.IE || goog.userAgent.EDGE)
                for (var e = d.getDescendants(), f = e.length - 1; 0 <= f; f--) e[f].render(!1);
            d.onMouseDown_(c);
            Blockly.dragMode_ = Blockly.DRAG_FREE;
            d.setDragging_(!0);
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block; border: 1px solid #ddd;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-webkit-user-select: none;", "-ms-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;", "position: absolute;",
    ...
    "cursor: se-resize;", "fill: #aaa;", "}", ".blocklyResizeSW {", "cursor: sw-resize;", "fill: #aaa;", "}", ".blocklyResizeLine {", "stroke: #888;", "stroke-width: 1;", "}", ".blocklyHighlightedConnectionPath {", "fill: none;", "stroke: #fc3;", "stroke-width: 4px;", "}", ".blocklyPathLight {", "fill: none;", "stroke-linecap: round;", "stroke-width: 2;", "}", ".blocklySelected>.blocklyPath {", "stroke: #fc3;", "stroke-width: 3px;", "}", ".blocklySelected>.blocklyPathLight {", "display: none;", "}", ".blocklyDraggable {", 'cursor: url(./media/handopen.cur), auto;',
    "cursor: grab;", "cursor: -webkit-grab;", "cursor: -moz-grab;", "}", ".blocklyDragging {", 'cursor: url(./media/handclosed.cur), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;", "cursor: -moz-grabbing;", "}", ".blocklyDraggable:active {", 'cursor: url(./media/handclosed.cur), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;", "cursor: -moz-grabbing;", "}", ".blocklyBlockDragSurface .blocklyDraggable {", 'cursor: url(./media/handclosed.cur), auto;', "cursor: grabbing;", "cursor: -webkit-grabbing;",
    ...
    "outline: none;", "}", ".blocklyTreeRow {", "height: 22px;", "line-height: 22px;", "margin-bottom: 3px;", "padding-right: 8px;", "white-space: nowrap;", "}", ".blocklyHorizontalTree {", "float: left;", "margin: 1px 5px 8px 0;", "}", ".blocklyHorizontalTreeRtl {", "float: right;", "margin: 1px 0 8px 5px;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "margin-left: 8px;", "}", ".blocklyTreeRow:not(.blocklyTreeSelected):hover {", "background-color: #00878f;", "}", ".blocklyTreeSeparator {", "border-bottom: solid #e5e5e5 1px;",
    "height: 0;", "margin: 5px 0;", "}", ".blocklyTreeSeparatorHorizontal {", "border-right: solid #e5e5e5 1px;", "width: 0;", "padding: 5px 0;", "margin: 0 5px;", "}", ".blocklyTreeIcon {", "background-image: url(./media/sprites.png);", "height: 16px;", "vertical-align: middle;", "width: 16px;", "}", ".blocklyTreeIconClosedLtr {", "background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "background-position: 0px -1px;", "}", ".blocklyTreeIconOpen {", "background-position: -16px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {",
...
Blockly.createDom_ = function(a, b) {
    ...
    d = Blockly.utils.createSvgElement("pattern", {
            id: "blocklyGridPattern" + e,
            patternUnits: "userSpaceOnUse"
        },
        d);
    0 < b.gridOptions.length && 0 < b.gridOptions.spacing && (Blockly.utils.createSvgElement("line", {
        stroke: b.gridOptions.colour
    }, d), 1 < b.gridOptions.length && Blockly.utils.createSvgElement("line", {
        stroke: b.gridOptions.colour
    }, d));
    b.gridPattern = d;
    return c
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function() {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop <
                d || a.contentTop + a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c))
